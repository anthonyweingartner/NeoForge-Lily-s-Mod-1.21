...
@Mod(Reblocked.MODID)
public class Reblocked {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "reblockedbylily";
    ...
    public Reblocked(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = Reblocked.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
