package net.Lily.lilymod.item.custom;
...
import net.Lily.lilymod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    static {
        MATERIAL_TO_EFFECT_MAP = (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                .put(ModArmorMaterials.LEATHER_MASTER_ARMOR_MATERIAL,
                ...
                .put(ModArmorMaterials.Chainmail_MASTER_ARMOR_MATERIAL,
                        List.of(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 2, false, false),
                                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 2, false, false)
                        ))
                .put(ModArmorMaterials.IRON_MASTER_ARMOR_MATERIAL,
                        List.of(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 3, false, false),
                ...
                .put(ModArmorMaterials.GOLD_MASTER_ARMOR_MATERIAL,
                        List.of(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 2, false, false),
                                new MobEffectInstance(MobEffects.DIG_SPEED, 200, 2, false, false)
                        ))
                .put(ModArmorMaterials.DIAMOND_MASTER_ARMOR_MATERIAL,
                        List.of(new MobEffectInstance(MobEffects.SATURATION, 200, 0, false, false),
                                new MobEffectInstance(MobEffects.NIGHT_VISION, 200, 0, false, false)
                        ))
                .put(ModArmorMaterials.NEITHERITE_MASTER_ARMOR_MATERIAL,
                        List.of(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 2, false, false),
